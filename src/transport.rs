...
/// Reject an origin response that could turn a missing asset into executable HTML.
/// A release manifest remains the source of the exact asset kind; the response MIME
/// is an additional server-side invariant, not a replacement for SHA-256 checking.
